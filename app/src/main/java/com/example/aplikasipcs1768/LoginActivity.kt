package com.example.aplikasipcs1768
...
import com.example.aplikasipcs1768.api.BaseRetrofit
import com.example.aplikasipcs1768.response.LoginResponse
import com.example.aplikasipcs1768.utils.SessionManager
            ...
            btnLogin.setOnClickListener{
                ...
                api.login(txtEmail.text.toString(),txtPassword.text.toString()).enqueue(object :
                    ...
                    override fun onResponse(
                        ...
                        val correct = response.body()!!.succes

                        if(correct){
                            val token = response.body()!!.data.token

                            sessionManager.saveString("TOKEN","Bearer "+token)
                            sessionManager.saveBoolen("LOGIN_STATUS",true)
